...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            @endif
            <form method="GET" action="{{url('/sendparceiroarmo/send')}}">
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <div class="card margintop">
                                <div class="card-header justify-content-center">
                                    <div class="row justify-content-center">
                                        <div class="col-md-12">
                                            <img class="animate__animated animate__fadeIn" src="{{asset('img/armo.jpg')}}"
                                                 style="height: 100%;width: 10%;float: right">
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body animate__animated animate__fadeIn">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h2 style="color: rgb(0,105,180)">Inscrição para o Treinamento de Segurança Online PFERD VSM em parceria com a Armo do Brasil
                                            </h2>
                                            <br>
                                            <h5>Para participar do nosso Treinamento de Segurança, basta preencher os dados da inscrição. Após finalizado o cadastro, enviaremos um link de acesso para o endereço de
                                                e-mail cadastrado.
                                            </h5>
                                            <h5>
                                                O treinamento será realizado no dia 10/06/2020 quarta-feira às 16h00.
                                            </h5>
                                            <h4>
